...
uses
  ...
  DBGrids, ExtCtrls, Menus, RLPDFFilter, ZConnection, ZDataset, ZSqlUpdate,
  IniFiles, ZAbstractDataset, ZSqlMetadata, LR_BarC, LR_E_TXT, LR_Desgn,
  LR_PGrid, ATGauge, Winsock, LR_DSet, LR_Shape, Variants;
...
type
  ...
  TDM = class(TDataModule)
    ...
    cds_AutoresDESCRICAO: TStringField;
    ...
    cds_CadCidadesCODIGO_IBGE: TLongintField;
    cds_CadCidadesDDD: TStringField;
    cds_CadCidadesDESCRICAO: TStringField;
    cds_CadCidadesID_CIDADE: TLongintField;
    ...
    cds_logNOME_ARQUIVO: TStringField;
    cds_User: TZQuery;
    ...
    sds_AutoresDESCRICAO: TStringField;
    ...
    sds_BuscaCidadesDESCRICAO: TStringField;
    sds_BuscaCidadesID_CIDADE: TLongintField;
    ...
    sds_Qry_CidadesCODIGO_IBGE: TLongintField;
    sds_Qry_CidadesDDD: TStringField;
    sds_Qry_CidadesDESCRICAO: TStringField;
    sds_Qry_CidadesID_CIDADE: TLongintField;
...
begin
  IncrementaPersonalizado('Cidade', cds_CadCidadesID_CIDADE);
end;
...
begin
  ...
  //  until sdt_Combo.EOF;
  //  Sleep(10000);
   Abertura.plGauge1.MaxValue := 100;
   Abertura.plGauge1.Progress := 10;
   Sleep(300);
   Abertura.plGauge1.Progress := 20;
   Sleep(300);
   Abertura.plGauge1.Progress := 30;
   Sleep(300);
   Abertura.plGauge1.Progress := 40;
   Sleep(300);
   Abertura.plGauge1.Progress := 50;
   Sleep(200);
   Abertura.plGauge1.Progress := 60;
   Sleep(200);
   Abertura.plGauge1.Progress := 80;
   Sleep(100);
   Abertura.plGauge1.Progress := 90;
   Sleep(200);
   Abertura.plGauge1.Progress := 100;
   Sleep(3000);
end;
