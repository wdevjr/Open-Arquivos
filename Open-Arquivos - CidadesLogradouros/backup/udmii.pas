...
type
  ...
  TDMII = class(TDataModule)
    ...
    sds_BuscaCidadeGridAbaCODIGO: TLongintField;
    sds_BuscaCidadeGridAbaNOME_CIDADE: TStringField;
    sds_BuscaCidadeGridAbaUF: TStringField;
    ...
    ZQuery1: TZQuery;
    ZQuery1CODIGO_IBGE: TLongintField;
    ZQuery1DDD: TStringField;
    ZQuery1DESCRICAO: TStringField;
    ZQuery1ID_CIDADE: TLongintField;
    ZQuery1UF: TStringField;
