object DM: TDM
  ...
  object sdt_UserAdd: TSQLDataSet
    CommandText = 
      ...
      'OS) and (A.IDUSUARIOS=:COD_USUARIO)'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftUnknown
  ...
  object sds_lista_Usuarios: TSimpleDataSet
    ...
    Connection = SQLConnection
    DataSet.CommandText = 
      'select U.COD_USUARIO, U.NOME,A.IDARQUIVOS,A.IDUSUARIOS  from USU' +
      'ARIO U'#13#10'inner join  ARQUIVOS_USUARIOS A  on U.COD_USUARIO = A.ID' +
      'USUARIOS'#13#10'where  (A.IDARQUIVOS=:IDARQUIVOS)'#13#10'order by U.NOME des' +
      'c'
    DataSet.MaxBlobSize = -1
    DataSet.Params = <
      item
