...
begin
  ...
  //  ' where NOME_CIDADE like ''' + Fstr_nome + '%''');
  ...
  begin
    ...
    begin
      with DMII.sds_BuscaCidadeGridAba do
      begin
        Close;
      ...
      try
        ...
        begin
          TEdit(Sender).Text := DMII.DSCidade.DataSet['NOME_CIDADE'];
        end;
...
procedure TFrmCadCidades.EdtNomeCidadesKeyUp(Sender: TObject;
