...
uses
  ...
  Dialogs, StdCtrls, Buttons, ExtCtrls, DB, DBCtrls, GifAnim, ZDataset, process, WinInet, Types;
...
type
  ...
  TFrmLogin = class(TForm)
    ...
    procedure EdtusuarioDrawItem(Control: TWinControl; Index: Integer;
...
procedure TFrmLogin.EdtusuarioDrawItem(Control: TWinControl; Index: Integer;
  ARect: TRect; State: TOwnerDrawState);
var
  aColor: TColor;
  aBrush: TBrush;
